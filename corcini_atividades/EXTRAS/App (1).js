...
function App() {
  ...
  return (
    <View style={{ backgroundColor: '#EFF3F6', flex: 1, paddingTop: 25 }}>
      ...
      <View style={{ backgroundColor: 'white', height: '13%', paddingTop: 20, flexDirection: 'row', paddingHorizontal: 20, justifyContent: 'space-between', alignItems: 'center' }}>
        <View style={{ flexDirection: 'row', alignItems: 'center' }}>
          <Image source={icons.usuario} style={{ width: 42, height: 42, marginRight: 10 }} />
          <Text style={{ fontSize: 15, fontWeight: '600', color: '#1a1a1a' }}>Fábio Henrique</Text>
        </View>
        <TouchableOpacity>
      ...
      <View style={{ backgroundColor: '#EFF3F6', flex: 1 }}>
        <ScrollView contentContainerStyle={{ padding: 12, paddingBottom: 20, gap: 10 }} showsVerticalScrollIndicator={false}>
          ...
          <View style={{ backgroundColor: 'white', borderRadius: 12, padding: 14, marginBottom: 2 }}>
            ...
            <TouchableOpacity style={{ flexDirection: 'row', alignItems: 'center', gap: 6, borderWidth: 0.5, borderColor: '#ddd', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 6, alignItems: 'center' }}>
